                                 ...
                                 FourDerivScalarTensor<CouplingAndPotential>>
{
  public:
    ...
    void read_params(GRParmParse &pp)
    {
        ...
        pp.load("mass_scale", coupling_and_potential_params.mass_scale, 0.1);
        pp.load("pot_mass", coupling_and_potential_params.pot_mass, 0.1);
        pp.load("center_BS", center_BS, center);
        pp.load("rad", rad, L);
